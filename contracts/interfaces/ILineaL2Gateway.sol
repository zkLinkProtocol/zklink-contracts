...
interface ILineaL2Gateway {
    event ClaimedDepositERC20(address token, uint104 amount, bytes32 zkLinkAddress, uint8 subAccountId, bool _mapping, bool success, bytes errorInfo);
    event ClaimedDepositETH(bytes32 zkLinkAddress, uint8 subAccountId, uint104 amount, bool success, bytes erroInfo);
