...
/// @author zk.link
interface IVerifier {
    function verifyAggregatedBlockProof(uint256 _totalAggNum, uint256[] memory _aggregatedInput, uint256[] memory _proof, uint256[] memory _blockInputs, uint256[16] memory _subProofsLimbs, bytes32 _oracleCommitment) external returns (bool);
