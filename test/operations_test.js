...
describe('Operations unit tests', function () {
    ...
    it('Correctly Parse Withdraw pubdata', async () => {
        const owner = '0x823B747710C5bC9b8A47243f2c3d1805F1aA00c5';
        const example = { chainId:1, accountId:32, subAccountId:4, tokenId:34, srcTokenId:34, amount:32, fee:14, owner:extendAddress(owner), nonce:45, fastWithdrawFeeRate:45 };
    ...
    it('Correctly Parse ForcedExit pubdata', async () => {
        ...
        const example = { chainId:1, initiatorAccountId:2, initiatorSubAccountId:1, targetAccountId:3, targetSubAccountId:4, tokenId:5, srcTokenId:5, feeTokenId:5, amount:6, fee:7, target:extendAddress(target) };
