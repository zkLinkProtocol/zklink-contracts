...
describe('Operations unit tests', function () {
    ...
    it('Correctly Parse ForcedExit pubdata', async () => {
        ...
        const example = { chainId:1, initiatorAccountId:2, initiatorSubAccountId:1, targetAccountId:3, targetSubAccountId:4, tokenId:5, srcTokenId:5, feeTokenId:5, amount:6, fee:7, target };
    ...
    it('Correctly Parse ChangePubKey pubdata', async () => {
        ...
        const example = { chainId:1, accountId:2, subAccountId:3, pubKeyHash, owner, nonce:3, tokenId:4, fee:5 };
